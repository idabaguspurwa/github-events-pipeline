    ...
    with TaskGroup("transformation_phase", dag=dag) as transformation_group:
        ...
        dbt_transform = NoTemplateKubernetesPodOperator(
            ...
            arguments=[
                ...
                "cat > models/production/daily_activity_summary.sql << 'EOF'\n"
                ...
                "cat > models/production/user_engagement_metrics.sql << 'EOF'\n"
                ...
                "cat > models/production/repository_popularity_rankings.sql << 'EOF'\n"
