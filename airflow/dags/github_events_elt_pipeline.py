    ...
    with TaskGroup("transformation_phase", dag=dag) as transformation_group:
        ...
        dbt_transform = KubernetesPodOperator(
            ...
            arguments=[
                ...
                "echo '-- Staging model for GitHub events data' > models/staging/stg_github_events.sql && "
                "echo 'select' >> models/staging/stg_github_events.sql && "
                "echo '    v:id::string as event_id,' >> models/staging/stg_github_events.sql && "
                "echo '    v:type::string as event_type,' >> models/staging/stg_github_events.sql && "
                "echo '    v:actor:id::int as actor_id,' >> models/staging/stg_github_events.sql && "
                "echo '    v:actor:login::string as actor_login,' >> models/staging/stg_github_events.sql && "
                "echo '    v:repo:id::int as repo_id,' >> models/staging/stg_github_events.sql && "
